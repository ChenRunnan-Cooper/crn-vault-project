...
contract ERC20VaultTest is Test {
    ...
    function test_DepositStandardToken_Success() public {
        ...
        // 验证余额
        assertEq(vault.getBalance(address(standardToken), USER_A), depositAmount, "User balance in vault should match deposit");
    ...
    function test_WithdrawStandardToken_Success() public {
        ...
        // 验证余额
        assertEq(vault.getBalance(address(standardToken), USER_A), depositAmount - withdrawAmount, "User vault balance should be reduced");
        assertEq(standardToken.balanceOf(USER_A), userBalanceBefore + withdrawAmount, "User wallet balance should increase");
        assertEq(standardToken.balanceOf(address(vault)), depositAmount - withdrawAmount, "Vault balance should be reduced");
    ...
    function test_DepositNonStandardToken_Success() public {
        ...
        // 验证余额
        assertEq(vault.getBalance(address(nonStandardToken), USER_A), depositAmount, "User balance in vault should match deposit");
    ...
    function test_WithdrawNonStandardToken_Success() public {
        ...
        // 验证余额
        assertEq(vault.getBalance(address(nonStandardToken), USER_A), depositAmount - withdrawAmount, "User vault balance should be reduced");
        assertEq(nonStandardToken.balanceOf(USER_A), userBalanceBefore + withdrawAmount, "User wallet balance should increase");
        assertEq(nonStandardToken.balanceOf(address(vault)), depositAmount - withdrawAmount, "Vault balance should be reduced");
